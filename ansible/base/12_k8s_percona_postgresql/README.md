...
Recursos que este laboratorio reserva en LXD (6 VMs base; +1 worker idéntico si se ejecuta el escalado de `[new_workers]`) — el host debe tener al menos esto libre, más margen para su propio sistema operativo:
