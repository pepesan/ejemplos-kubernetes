...
run_playbook 09 09_despliegue_test.yml              "Desplegar aplicación de prueba multinodo y verificar"
run_playbook 10 10_prueba_resiliencia_ha.yml        "Probar resiliencia HA (caída de un worker y de un manager)"
